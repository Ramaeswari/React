...
class Feedback extends Component{
    ...
    callingAlert(){
        <Alert color="primary">Thanks for ur feedback</Alert>
    }
    handleSubmit = e =>{
        e.preventDefault();
    ...
    return(
        <div className="feedbackData">
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <div class="form-group row">
                    <div class="col-sm-2"><label className="col-form-label">Any comments or suggestions</label></div>
